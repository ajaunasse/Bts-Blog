...
**/
{
	...
	/**
	* Constructeur
	*@param $request objet request du site
	**/
	...
	function __construct($request=null)
	{
		...
		if($request)
		{
			$this->request = $request ;		//Stockage de la request de l'instance
	...
	*@param $view Fichier à rendre (chemin depuis la view ou nom de la vue)
	**/
	...
	*@param $value valeur de la variable, paramètre non obligatoire
	**/
	...
	**/
	...
	/**
	* Permet de rédiriger l'utilisateur en cas d'erreur d'url
	**/
